...
base_path = Path(
    "/dls/science/groups/das/ExampleData/B24_test_data/StitchM_test_data/files"
)
test_files = (
...
expected_outputs = [
    path.replace(".txt", "_expected_output.ome.tiff") for path in test_files
]
expected_marked_outputs = [
    path.replace(".txt", "_marked_expected_output.ome.tiff") for path in test_files
]
